...
<head>
    ...
    <script type="text/javascript">
        ...
        //更换验证码
        function change() {
            $(".wordplf").children().prop("src", "getKaptcha.do?t=" + new Date().getTime());
        }
    </script>
</head>
<body>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="enCode" name="kaptcha" class="text captcha" maxlength="4"
                           autocomplete="off"/>
                    <span class="wordplf"><img height="30" width="65" id="captchaImage" class="captchaImage"
                                               src="getKaptcha" title="点击更换验证码" onClick="change()"/></span>
                </td>
            </tr>
            <tr>
                <td>
